...
An end-to-end Deep Learning pipeline using TensorFlow 2.10 and 2D CNNs to classify audio speech commands ("yes"/"no") from STFT spectrograms with 92.5% test accuracy.
